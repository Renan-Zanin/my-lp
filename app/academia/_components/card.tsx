...
export default function Card() {
  return (
    <div className="grid grid-cols-3 gap-10">
      <div className="relative group flex items-center justify-center h-[400px] w-[300px] bg-cover bg-[url('/card-1.webp')] overflow-hidden rounded-2xl cursor-pointer hover:scale-[1.025] transition duration-300 ease-in-out ">
