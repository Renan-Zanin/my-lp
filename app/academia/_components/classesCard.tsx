...
export default function ClassesCard({ type, exercise }: ClassesCardProps) {
  return (
    <div className="relative group z-20 h-[397px] w-[347px] bg-rose-600 rounded-3xl flex flex-col p-4 items-center justify-center hover:translate-y-24 transition duration-500 ease-in-out">
      <div className="absolute z-40 h-[400px] w-[350px] bg-cover bg-[url('/card-3.jpg')] bottom-0 right-0 rounded-3xl group-hover:-translate-y-36 transition duration-500 overflow-hidden">
      ...
      <div className="z-30 hidden items-center group-hover:flex flex-col pt-[300px] text-white transition duration-500 mb-12">
        <span className="text-center text-[18px] transition duration-500 ease-in-out mb-0">
          {type}
        </span>
        <p className="text-center mb-4 text-3xl transition duration-500 ease-in-out">
          {exercise}
        </p>
        <Button
          variant="gym"
